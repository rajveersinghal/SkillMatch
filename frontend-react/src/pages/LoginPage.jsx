...
import { Lock, Mail, Loader2, Sparkles, ArrowRight, Home } from 'lucide-react';
                ...
                <div className="glass p-8 md:p-12 rounded-[2.5rem] md:rounded-[3.5rem] border-white/5 shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="flex flex-col items-center mb-12">
                        <motion.div
                            initial={{ rotate: -10 }}
                            animate={{ rotate: 0 }}
                            className="w-20 h-20 bg-blue-600 rounded-[2rem] flex items-center justify-center shadow-2xl shadow-blue-500/20 mb-6"
                        >
                            <Sparkles className="text-white w-10 h-10" />
                        </motion.div>
                        <h1 className="text-3xl font-black text-white tracking-tighter">
                            SkillMatch <span className="text-blue-500 italic">AI</span>
                        </h1>
                        <p className="text-white/40 font-bold mt-2 uppercase tracking-[0.2em] text-[10px]">Sign in to your account</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        <div className="space-y-3">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-16 pr-6 py-5 bg-white/5 border border-white/5 rounded-[1.5rem] focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500/30 text-white font-medium transition-all"
                                    required
                                />
                            </div>
                        </div>
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="group relative w-full py-6 bg-blue-600 hover:bg-blue-500 disabled:bg-white/5 disabled:text-slate-600 text-white font-black rounded-[2rem] transition-all flex items-center justify-center gap-4 shadow-2xl shadow-blue-900/20 active:scale-[0.98] text-base uppercase tracking-[0.2em] overflow-hidden"
                        >
                    ...
                    <p className="mt-12 text-center text-white/30 text-[10px] font-bold">
                        New to SkillMatch? {' '}
                        <Link to="/register" className="text-blue-500 hover:text-blue-400 transition-colors underline decoration-2 underline-offset-8 uppercase tracking-widest ml-2">
                            Create Account
                        </Link>
                    </p>
                </div>
